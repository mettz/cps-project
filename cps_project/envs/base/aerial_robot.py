...
from cps_project.envs.controllers.controller import Controller
from cps_project.utils.helpers import asset_class_to_AssetOptions
...
class AerialRobot(BaseTask):
    def __init__(
        self, cfg: AerialRobotCfg, sim_params, physics_engine, sim_device, headless
    ):
        self.cfg = cfg
    ...
    def _create_envs(self):
        ...
        asset_path = self.cfg.robot_asset.file.format(
            cps_project_ROOT_DIR=cps_project_ROOT_DIR
        )
    ...
    def reset_idx(self, env_ids):
        ...
        self.root_states[env_ids, 0:3] = 2.0 * torch_rand_float(
